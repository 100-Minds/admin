		...
		<div className="w-full min-h-screen px-6 md:px-[9vw] flex flex-col justify-center">
			...
			<div className="flex flex-col md:flex-row items-center justify-between gap-8">
				<div className="flex-1 order-2 md:order-1">
					<h1 className="mb-6 text-4xl md:text-6xl font-bold text-primary">Uh oh, an error occurred...</h1>
					<h3 className="text-lg md:text-xl md:max-w-[90%]">An error occurred on our server. Please try again later</h3>
