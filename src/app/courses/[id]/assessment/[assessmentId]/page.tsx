...
export default async function EditAssessment(props: { params: Promise<{ id: string; assessmentId: string }> }) {
	const { assessmentId, id } = await props.params;

	return (
		<DashboardLayout heading="Edit">
			<div className="mb-5">
				<div className="flex items-center justify-center">
					<AssessmentEditForm courseId={id} assessmentId={assessmentId} />
				</div>
			</div>
		</DashboardLayout>
	);
